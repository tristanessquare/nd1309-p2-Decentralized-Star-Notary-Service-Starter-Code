...
contract StarNotary is ERC721 {
    ...
    string public name = "The Ultimate Star Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address ownerOfTk1 = ownerOf(_tokenId1);
        address ownerOfTk2 = ownerOf(_tokenId2);
        require(msg.sender == ownerOfTk1 || msg.sender == ownerOfTk2, "Sender is not owner of Star1 or Star2");

        _transferFrom(ownerOfTk1, ownerOfTk2, _tokenId1);
        _transferFrom(ownerOfTk2, ownerOfTk1, _tokenId2);
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "Sender is not owner of the Star");
